...
class MainViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        collectionViewPlaceholder.layer.cornerRadius = collectionViewPlaceholder.frame.size.height * Resources.cornerRadiusCoefficient
    ...
    private func layout() {
        ...
        NSLayoutConstraint.activate([
            ...
            collectionViewPlaceholder.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 8),
            collectionViewPlaceholder.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -8),
